...
//int mem = freeRam();
  ...
  prog_char phrase1[] PROGMEM = "     Subaru        Impossibru   ";
  prog_char phrase2[] PROGMEM = "Sit down shut up  and hang on   ";
  prog_char phrase3[] PROGMEM = "Scubaru: beware    deep water   ";
  prog_char phrase4[] PROGMEM = "Guess what will    fail today   ";
  prog_char phrase5[] PROGMEM = "    ur a bus                    ";
  prog_char phrase6[] PROGMEM = "Prepare ship for ludicrous speed";
  prog_char phrase7[] PROGMEM = "60% of time it  works every time";
  prog_char phrase8[] PROGMEM = "  Understeers      like a pig   ";
  prog_char phrase9[] PROGMEM = "The password is    'password'   ";
  prog_char phrase10[] PROGMEM = "      Stop.        Hammer time  ";
  prog_char phrase11[] PROGMEM = "vtec just kicked      in yo     ";
  prog_char phrase12[] PROGMEM = " When in doubt,     flat out    ";
  prog_char phrase13[] PROGMEM = "   See no Evo,    hear no Evo...";
  prog_char phrase14[] PROGMEM = "   Cool story,         bro      ";
  prog_char phrase15[] PROGMEM = "  What is that  rattling sound?!";
  prog_char phrase16[] PROGMEM = "     Made in     Australia -_-  ";
  prog_char phrase17[] PROGMEM = "  Power Level:   It's over 9000!";
  prog_char phrase18[] PROGMEM = "Do a barrel roll                ";
  prog_char phrase19[] PROGMEM = "     (-_-)zzz                   ";
  prog_char phrase20[] PROGMEM = "   Drive free        or die     ";
  prog_char phrase21[] PROGMEM = "   Hello Dave                   ";
  prog_char phrase22[] PROGMEM = " It's dangerous   to go alone!  ";
  prog_char phrase23[] PROGMEM = " All your base  are belong to us";
  prog_char phrase24[] PROGMEM = "   It's super      effective!   ";
  prog_char phrase25[] PROGMEM = " After testing   there is cake  ";
  
  PROGMEM const char *phraseSet[] = {phrase1,phrase2,phrase3,phrase4,
...
void loop() 
{
  ...
  else
  {
    ...
    for(int count = 0; count < 884; count++) //about 60s loop
    {
      //time = micros();
      //Serial.println(time);
